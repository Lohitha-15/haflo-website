        ...
        <div className="w-full lg:w-1/2 relative">
          <div className="relative overflow-hidden rounded-lg">
            <img 
              ...
              className="w-4/5 lg:w-3/4 h-auto rounded-lg shadow-lg object-cover"
            />
            
            {/* Blue overlay box with year */}
            <div className="absolute bottom-0 left-0 bg-blue-900 text-white p-8 md:p-10 rounded-tr-lg">
              <div className="text-[#c4fc68] text-6xl md:text-7xl lg:text-8xl font-bold">1992</div>
