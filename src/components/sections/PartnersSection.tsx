...
//             <div key={`logo1-${index}`} className="flex-shrink-0 w-48 h-20 mx-12 flex items-center justify-center">
//               <img src={logo} alt={`Partner logo ${index + 1}`} className="max-w-full max-h-full" />
//             </div>
//           ))}
          
//           {/* Duplicate set for continuous scrolling */}
//           {partnerLogos.map((logo, index) => (
//             <div key={`logo2-${index}`} className="flex-shrink-0 w-48 h-20 mx-12 flex items-center justify-center">
//               <img src={logo} alt={`Partner logo ${index + 1}`} className="max-w-full max-h-full" />
//             </div>
//           ))}
//         </div>
