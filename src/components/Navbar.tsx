...
//           {/* Grouped Navigation Buttons in a Single Border */}
//           <div className="flex items-center border border-gray-300 px-4 py-2 rounded-lg overflow-hidden">
//             {/* All Pages Dropdown */}
//             <div className="relative group">
//               <button className="flex items-center text-blue-900 font-medium rounded-md hover:bg-blue-800 hover:bg-gray-100 px-2 py-1">
//                 All Pages <ChevronDown className="ml-1 h-4 w-4" />
//               </button>
//               {/* Dropdown Menu */}
//               <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md hidden group-hover:block transition-all duration-300 z-50">
...
//             {/* Property */}
//             <a href="#" className="text-blue-900 font-medium rounded-md hover:bg-blue-800 hover:bg-gray-100 hover:text-blue-800 px-2 py-1">
//               Property
//             </a>
    ...
    <nav className="bg-white py-6 px-6 md:px-12 shadow-sm">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-6 border border-gray-300 rounded-lg p-2 hover:border-blue-900 hover:bg-gray-100 transition-all">
            {/* All Pages Dropdown */}
            <div
              className="relative"
            ...
            >
              <button
                onClick={() => setActiveLink('all-pages')}
                className={`flex items-center text-blue-900 font-medium rounded-md px-2 py-1 ${activeLink === 'all-pages' ? 'bg-gray-100 px-4 py-2 m-1' : ''}`}
              >
                All Pages <ChevronDown className="ml-1 h-4 w-4" />
              </button>
            ...
            <a
              ...
              href="#"
              className={`text-blue-900 font-medium rounded-md px-2 py-1 ${activeLink === 'property' ? 'bg-gray-100 px-4 py-2 m-1' : ''}`}
            >
              Property
            </a>
            ...
            <a
              ...
              href="#"
              className={`text-blue-900 font-medium rounded-md px-2 py-1 ${activeLink === 'contact' ? 'bg-gray-100 px-4 py-2 m-1' : ''}`}
            >
              Contact Us
            </a>
          </div>
